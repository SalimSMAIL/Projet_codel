...
public class DisplayContactsGroupServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public DisplayContactsGroupServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		getServletContext().getRequestDispatcher("/listContactPerGroup.jsp").forward(request, response);
